...
$html .= '<div class="container-body">
        <p class="text-uppercase text-center  mb-0">Surat Peringatan-1</p>
        ...
        <p>Sesuai dengan Peraturan Direktur Politeknik Negeri Sriwijaya Nomor 1 Tahun 2018 tentang Peraturan Akademik dan Tata Tertib Mahasiswa Politeknik Negeri Sriwijaya
            dan Rekapitulasi Ketidak Hadiran Mahasiswa, maka Direktur Politeknik Negeri Sriwijaya Mengeluarkan <i>Surat Peringatan 1 (Pertama)</i> kepada
            <br>Mahasiswa :</p>
        <table>
            <tr>
                <td>Nama</td>
